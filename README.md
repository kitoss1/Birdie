...
**Windowsill** és un joc d'escriptori cozy i quasi-idle per a Windows. S'executa com una superposició transparent just per sobre de la barra de tasques, convertint la part inferior de la pantalla en un ampit de finestra virtual on els ocells fan visites en temps real.
...
Treball en curs (WIP). Desenvolupat com a Treball de Fi de Grau (TFG).
